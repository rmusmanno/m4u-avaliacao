...
const bookmarkDefaultReturnFields = {
	'url': '1',
	'owner': '1',
	'updated': '1'
};
...
exports.list = function(req, res) {
	...
	Obj.find(params, bookmarkDefaultReturnFields, {
		sort: {
			owner: 1
		}
	}, function(err, objs) {
...
exports.update = function(req, res) {
	if (req.body.url) {
		...
		var opts = {
			'new': true,
			'fields': bookmarkDefaultReturnFields
		};
		var upd = req.body;
...
exports.delete = function(req, res) {
	...
	Obj.findOne(params, bookmarkDefaultReturnFields, function(err, obj) {
		...
		obj.remove();
		Utils.return_ok(res, {
			"message": "Object " + obj._id + " was deleted."
		});
	});
};